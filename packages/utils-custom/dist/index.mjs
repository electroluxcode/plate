...
var ExitBreakPlugin = createSlatePlugin({
  key: KEYS.exitBreak,
  editOnly: true
...
import { createTSlatePlugin } from "@platejs/core";
...
import { createSlatePlugin as createSlatePlugin2 } from "@platejs/core";
var SingleBlockPlugin = createSlatePlugin2({
...
import { createSlatePlugin as createSlatePlugin3 } from "@platejs/core";
...
// src/lib/plugins/single-block/SingleLinePlugin.ts
var SingleLinePlugin = createSlatePlugin3({
  key: KEYS.singleLine,
  override: {
    enabled: {
      [KEYS.trailingBlock]: false
...
import { createTSlatePlugin as createTSlatePlugin2 } from "@platejs/core";
  ...
  transforms: {
    normalizeNode([currentNode, currentPath]) {
      ...
      if (currentPath.length === 0) {
        ...
        if (!lastChildNode || lastChildNode.type !== type && queryNode(lastChild, query) || match?.(lastChildNode)) {
...
// src/lib/plugins/trailing-block/TrailingBlockPlugin.ts
var TrailingBlockPlugin = createTSlatePlugin2({
